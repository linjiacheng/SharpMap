...
//			ConfigurationManager.GetSection("LayerFactories");
        ...
        private static void GeneratePolygons(IGeometryFactory factory, ICollection<Geometry> geometry, Random rndGen)
        {
        ...
        private static void GenerateLines(IGeometryFactory factory, ICollection<Geometry> geometry, Random rndGen)
        {
        ...
        private static void GeneratePoints(IGeometryFactory factory, ICollection<Geometry> geometry, Random rndGen)
        {
